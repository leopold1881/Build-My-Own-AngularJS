...
describe('parse', function () {
  ...
  it('will parse an object with identifer keys', function () {
  ...
  it('use locals instead of scope when there is a matching key', function () {
    var fn = parse('aKey');
    var scope = {aKey: 42};
    var locals = {aKey: 43};
  ...
  it('binds bare functions to scope', function () {
      var scope = {
        aFunction: function () {
          return this;
        }
  ...
  it('does not allow functions to returnw window', function () {
    var fn = parse('getWnd()');
  ...
  it('parses several miltiplicatives', function () {
  ...
  it('can pass serveral additional arguments to filters', function () {
