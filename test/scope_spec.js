...
describe('Scope', function() {
  ...
  describe('digest', function() {
    ...
    it('calls the lisenter function of a watch on first $digest', function () {
  ...
  describe('$evalAsync', function () {
    ...
    it('excutes given function later in the same cycle', function () {
      scope.aValue = [1, 2, 3];
  ...
  describe('$postDigest', function () {
    ...
    it('does not include $$postDigest in the digest', function () {
      ...
      scope.$digest();
      expect(scope.watchedValue).toBe('oringial value');
  ...
  describe('inheritance', function () {
    ...
    it('digest from the root on $apply when isolated', function () {
      var parent = new Scope();
      var child = parent.$new(true);
      var child2 = child.$new();
    ...
    it('executes $evalAsyn functions on isolated scopes', function(done) {
      var parent = new Scope();
      var child = parent.$new(true);

      child.$evalAsync(function(scope) {
        scope.didEvalAsyn = true;
      });

      setTimeout(function() {
        expect(child.didEvalAsyn).toBe(true);
        done();
      }, 50);
    });
  ...
  describe('$watchCollection', function () {
    ...
    it('notices items orderded in an array', function () {
      scope.arr = [2, 1, 3];
      scope.counter = 0;
  ...
  describe('Events', function () {
    ...
    _.forEach(['$emit', '$broadcast'], function(method) {
      ...
      it('passes an event object with a name to liserners on ' + method, function () {
      ...
      it('passes the same event object to each listerner on ' + method, function () {
        var listener1 = jasmine.createSpy();
        var listener2 = jasmine.createSpy();
        scope.$on('someEvent', listener1);
        scope.$on('someEvent', listener2);
      ...
      it('passes additional arguments to listeners on ' + method, function () {
        ...
        scope[method]('someEvent', 'and', ['additonal', 'arguments'], '...');

        expect(listener.calls.mostRecent().args[1]).toEqual('and');
        expect(listener.calls.mostRecent().args[2]).toEqual(['additonal', 'arguments']);
    ...
    it('propagates up the score hierarchy on $emit', function () {
    ...
    it('is received by listeners on current scope afer being stopped', function () {
      var listener1 = function (event) {
        event.stopPropagation();
      };
      var listener2 = jasmine.createSpy();
